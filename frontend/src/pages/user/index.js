  ...
  return <Main>
    <Container className={styles.container}>
      <MetaTags>
        ...
        <meta name="description" content={user ? `Хакатон - ${user.first_name} ${user.last_name}` : 'Хакатон - Страница пользователя'} />
      ...
      >
        {subscribed ? 'Отписаться от преподователя' : 'Подписаться на преподователя'}
      </Button>}
      <CardList>
